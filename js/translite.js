function translit(){
	...
	var text = $('#family').val().toLowerCase()+ $('#name').val().toLowerCase().substr(0,1) + $('#middle_name').val().toLowerCase().substr(0,1);
	...
	// Выводим результат
	$('#user_login').val(result)+ $('#email').val(result + '@spzgroup.ru');
